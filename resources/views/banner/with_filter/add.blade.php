                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/add_banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="short_title" name="short_title" value="{{ old('short_title') }}"/>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="pt-1"><strong>Recommended Size: 493 x 640 px</strong> | Allowed Types: jpg,jpeg,png | Maxfile Size: 1MB</div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control ckeditor" id="description" name="description" rows="2">{{ old('description') }}</textarea>
                                    <span class="text-danger">
                            ...
                            <div class="row mb-6">
                                <label class="col-sm-2 col-form-label" for="basic-default-message">Sequence <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="sequence" name="sequence" value="{{ $sequence }}"/>
                                    <span class="text-danger">
